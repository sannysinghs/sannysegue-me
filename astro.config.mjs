...
export default defineConfig({
  ...
  integrations: [
    ...
    AstroPWA({
      ...
      includeAssets: ["favicon.ico", "sanny-avatar.webp"],
      manifest: {
        name: "Sanny Segue",
        short_name: "Sanny Segue",
        description: "Father, Android engineer, problem solver, and lifelong learner. Born in Yangon, now building tech in Singapore.",
        theme_color: "#006cac",
